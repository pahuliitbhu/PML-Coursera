...
##final predictors will be those  which does not have NA value, lets view final predictors
colnames(testing)
...
##Lets train the data on two different models
...
##Random forests resulted in better accuracy of 99.4%
